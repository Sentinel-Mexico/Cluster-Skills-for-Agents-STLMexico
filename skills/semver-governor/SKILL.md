...
metadata:
  ...
  skill-origin: "skills/semver-governor"
...
> "⚠️ Se detectó una nueva versión de la skill `semver-governor` (v<latest_version> disponible, v<current_version> instalada). ¿Deseas actualizar antes de continuar? [S/N]"
...
- If installed as standalone/copy: execute:
  `npx skills add Sentinel-Mexico/Cluster-Skills-for-Agents-STLMexico --skill semver-governor --agent <active-agent> --force`
